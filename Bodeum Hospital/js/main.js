...
// tab
$('.tit h4').mouseover(function(){
  $('.titbox').stop().slideUp();
  $(this).siblings('.titbox').stop().slideDown()
})
$('.tit h4').mouseout(function(){
  $('.titbox').stop().slideUp();
  $(this).siblings('.titbox').stop().slideUp()
})


// slide
setInterval(function(){
  $('.itemWrap').animate({top :-340},function(){
    $('.itemWrap div').first().appendTo('.itemWrap')
    $('.itemWrap').css({top: 0})
  })
},7000)
